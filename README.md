...
Road packages are release attachments, not files inside the APK. They use Valhalla 3.6.3 and include a manifest and SHA-256 checksum. Display maps come directly from Geofabrik.

Geographic data © [OpenStreetMap contributors](https://www.openstreetmap.org/copyright), available under the [Open Database License](https://opendatacommons.org/licenses/odbl/1-0/). Original country extracts are available from [Geofabrik Africa](https://download.geofabrik.de/africa.html). These database licensing terms apply to the geographic datasets; they do not grant a license to unrelated application code.

Country road packages: Namibia, Angola, Botswana, Zambia, Zimbabwe, Mozambique, and South Africa & Lesotho. Botswana uses a shared regional graph covering Namibia, Angola and Botswana, so its road download includes additional neighbouring data.
